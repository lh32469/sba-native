...
* The following dependencies are not known to work with Spring Native: 'Codecentric's Spring Boot Admin (Server), Codecentric's Spring Boot Admin (Client)'. As a result, your application may not work as expected.
* The original package name 'org.gpc4j.sba-native' is invalid and this project uses 'org.gpc4j.sbanative' instead.
...
```
$ docker run --rm sba-native:0.0.1-SNAPSHOT
```
